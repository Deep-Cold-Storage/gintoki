...
<TopNavigation/>
  <div class="flex flex-col items-center justify-center w-full h-auto">
    <div class="my-10 mx-auto">
      <section class="w-auto p-24 shadow-lg md:rounded-full">
        ...
        <div class="flex flex-col items-center justify-between w-full mt-8 lg:items-end lg:flex-row">
          ...
          <button
            class="px-8 py-3 mx-5 my-5 text-lg md:text-sm font-medium text-white rounded-full lg:my-0 bg-primary disabled:bg-gray disabled focus:outline-none"
